...
class Network(object):
    ...
    def total_cost(self, data, lmbda=0):
            ...
            for x,y in data:
                    ...
                    c += 1.0/n * self.cost(h,y)
            c += lmbda/(2*n) * np.sum(np.linalg.norm(w)**2 for w in self.weights)
            return c
    ...
    def SGD(self, training_data, test_data, epochs, mini_batch_size, eta,
            ...
            for j in range(epochs):
                    ...
                    cost_array.append(self.total_cost(training_data, lmbda)) 
